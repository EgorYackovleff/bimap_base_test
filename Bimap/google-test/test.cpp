...
/*constexpr*/ auto cycles_count = 5;


TEST(Bimap, add_values_2xMapBomap)
{
...
TEST(Bimap, add_and_erase_by_key_2xMapBomap)
{
    container::bimap_second<std::string, int> bimap;
...
TEST(Bimap, add_and_erase_by_value_2xMapBomap)
{
    container::bimap_second<std::string, int> bimap;
...
TEST(Bimap, check_key_unique_2xMapBomap)
{
    container::bimap_second<std::string, int> bimap;
...
TEST(Bimap, check_val_unique_2xMapBomap)
{
    container::bimap_second<std::string, int> bimap;
...
TEST(Bimap, compare_ret_data_by_key_2xMapBomap)
{
    container::bimap_second<std::string, int> bimap;
...
TEST(Bimap, compare_ret_data_by_val_2xMapBomap)
{
    container::bimap_second<std::string, int> bimap;
